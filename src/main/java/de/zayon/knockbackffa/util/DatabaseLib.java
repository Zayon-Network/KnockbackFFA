package de.zayon.knockbackffa.util;
...
public class DatabaseLib implements Closeable {
    ...
    public DatabaseLib(KnockbackFFA knockbackFFA) {
        this.knockbackFFA = knockbackFFA;
        HikariConfig hikariConfig = new HikariConfig();
        hikariConfig.setJdbcUrl((String) knockbackFFA.getGeneralConfig().getOrSetDefault("config.database.url", "jdbc:mysql://localhost:3306/database"));
        hikariConfig.setUsername((String) knockbackFFA.getGeneralConfig().getOrSetDefault("config.database.username", "username"));
        hikariConfig.setPassword((String) knockbackFFA.getGeneralConfig().getOrSetDefault("config.database.password", "password"));
        hikariConfig.addDataSourceProperty("cachePrepStmts", "true");
        hikariConfig.addDataSourceProperty("prepStmtCacheSize", "250");
        hikariConfig.addDataSourceProperty("prepStmtCacheSqlLimit", "2048");
        knockbackFFA.getGeneralConfig().save();
